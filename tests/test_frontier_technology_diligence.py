...
class FrontierTechnologyDiligenceTests(unittest.TestCase):
    ...
    def test_02_decision_boundary_is_bounded(self) -> None:
        ...
        self.assertIn("unbounded_commitment", boundary["not_authorized"])
        self.assertIn("deployment_authorization", boundary["not_authorized"])
    ...
    def test_04_public_example_states_the_provenance_and_action_boundary(self) -> None:
        ...
        self.assertIn("does not recommend or execute a real-world decision", text)
    ...
    def test_07_readme_preserves_product_boundary_and_user_orientation(self) -> None:
