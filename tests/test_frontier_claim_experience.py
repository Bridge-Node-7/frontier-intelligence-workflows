...
class FrontierClaimExperienceTests(unittest.TestCase):
    ...
    def test_20_experience_remains_case_oriented_and_offline(self) -> None:
        self.assertNotIn('aria-labelledby="closing-title"', self.html)
        self.assertNotIn("BridgeNode7.com", self.html)
        self.assertNotRegex(self.html, r"https?://")
