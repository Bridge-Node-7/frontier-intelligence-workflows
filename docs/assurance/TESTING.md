...
The gate checks defined software behavior, approved repository structure, public boundaries, workflow controls, selected language-integrity and source-safety conditions, manifest parity, and deterministic release construction. It does not determine external truth, qualification, readiness, investment merit, or deployment authority.
