...
FIW automation can check declared structure, traceability, selected language-integrity conditions, selected evidence conditions, repository integrity, approved public structure, selected credential and path patterns, workflow controls, links, structured-artifact syntax/metaschema validity, manifests, and deterministic release construction.
